...
annotate service.Temperatures with @(
    ...
    UI.Identification         : [{
        ...
        @UI.Hidden: (not isButtonApiVisible),
    }, ],
);
...
annotate service.Sources with {
    code @Common.Text: text
};

annotate service.Temperatures with @(Common: {SideEffects #changeIsButtonVisible: {
